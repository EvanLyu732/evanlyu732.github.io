...
上图的N2G论文原文的描述, 可以看到是将语言模型输出的回答进行关联生成一张有向图. 

# TODO
<!-- 作者通过N2G解释对比

最后作者比较了TopK ，并且论述了TopK的缺点: -->
...
#  Bonus: Play With Code

假设你很有耐心并且准备进一布了解. this section is for you. 让我们通过代码去进一步的了解sparse autoencoder. 
